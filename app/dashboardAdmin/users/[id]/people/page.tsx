...
type UserDetail = {
  ...
  payments: { id: string; amount: number; paymentDate: string | null }[];
};
...
export default function UserEditPage() {
      ...
      try {
        ...
        setFormData({
          ...
          subscriptionStartDate: formatDate(
            data.company?.subscriptionStartDate
          ),
          subscriptionEndDate: formatDate(data.company?.subscriptionEndDate),
          clientRegistrationCount: data.company?.clientRegistrationCount || 0,
          maxClientRegistrations: data.company?.maxClientRegistrations || 0,
          paymentCount: data.company?.paymentCount || 0,
          maxPayments: data.company?.maxPayments || 0,
        });
      } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Prepare the payload, excluding empty password field if not changed
    const payload: any = {
